...
function setup(loader, res){
    ...
    app.ticker.add(()=>{
        ...
        if( global.gamePlay ){
            ...
            //障碍物动起来
            trackBarrie['barrier1'].y=trackBarrie['barrier1'].y+barrieRdArr.rd1+_plusSpeed;
            trackBarrie['barrier2'].y=trackBarrie['barrier2'].y+barrieRdArr.rd2+_plusSpeed;
            trackBarrie['barrier3'].y=trackBarrie['barrier3'].y+barrieRdArr.rd3+_plusSpeed;
            trackBarrie['barrier4'].y=trackBarrie['barrier4'].y+barrieRdArr.rd4+_plusSpeed;
            //超出了赛道，那么从另外一条道中从新开始
